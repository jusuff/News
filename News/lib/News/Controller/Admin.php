...
{
    // Return the output that has been generated by this function
    return ModUtil::func('News', 'user', 'new');
}
...
*/
    ...
    $render->assign('pager', array('numitems' => ModUtil::apiFunc('News', 'user', 'countitems', array('category' => isset($catFilter) ? $catFilter : null)),
...
function News_admin_updateconfig()
{
    ...
    ModUtil::setVars('News', $modvars);

    // Let any other modules know that the modules configuration has been updated
    ModUtil::callHooks('module','updateconfig','News', array('module' => 'News'));
