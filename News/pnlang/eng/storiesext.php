...
define('_STORIES_DISPLAYFRONTPAGE','Show only front-page articles');
define('_STORIES_DISPLAYNONFRONTPAGE','Show only articles not published on front page');
...
define('_STORIES_HOMETEXTCLASS','Optional styleclass for the hometext display'); 
...
define('_STORIES_SELECTALL', 'All');
define('_STORIES_SELECTNONE', 'None');
define('_STORIES_SHOWEMPTYRESULT', 'Show \'No News\' block output for no News instead of empty block');
...
define('_STORIES_UNKNOWN', 'Unknown');

define('_STORIES_WHICHSTORIES', 'Articles to display (frontpage)');