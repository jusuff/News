    ...
    switch($story['action']) {
        case 'update':
            ...
            if (pnModAPIFunc('News', 'admin', 'update',
                ...
                // the url for reloading, for shorturls definitely needed
                $reloadurl = pnModURL('News', 'user', 'display', array('sid' => $info['sid'], 'page' => $page));
        ...
        case 'pending':
            ...
            if (DBUtil::updateObject($object, 'stories', '', 'sid') == false) {
                ...
                $reloadurl = pnModURL('News', 'user', 'view');
