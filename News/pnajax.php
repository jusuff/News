...
function News_ajax_modify()
{
    ...
    return array('result' => $pnRender->fetch('news_ajax_modify.htm'));
}
    ...
    switch($story['action']) {
        case 'update':
            ...
            if (pnModAPIFunc('News', 'admin', 'update',
                ...
                $pnRender->cache_id = $story['sid'].$page;
                ...
                // For caching reasons you must pass a cache ID
                $pnRender->cache_id = $story['urltitle'].$page;
                // check out if the contents are cached.
                if ($pnRender->is_cached('news_user_article.htm')) {
                    return $pnRender->fetch('news_user_article.htm');
                }
                ...
                // Return the output that has been generated by this function
                $output = $pnRender->fetch('news_user_articlecontent.htm');
            } else {
