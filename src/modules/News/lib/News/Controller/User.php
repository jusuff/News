...
class News_Controller_User extends Zikula_Controller
{
    ...
    public function newitem($args)
    {
        ...
        if (strtolower($type) == 'admin') {
            return $this->view->fetch('news_admin_create.htm');
        } else {
            return $this->view->fetch('news_user_create.htm');
        }
    }
...
%6$s', array($item['title'], $contributor, $sitename, $item['hometext'], ModUtil::url('News', 'admin', 'view', array('news_status' => 2), null, null, true), $sitename));
    ...
    public function view($args = array())
    {
        ...
        foreach ($items as $item)
        {
            ...
            if (($item['published_status'] == 0) &&
                ...
                $newsitems[] = $this->view->fetch('news_user_index.htm', $item['sid']);
            }
        }
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('news_user_view.htm');
    }
    ...
    public function display($args)
    {
        ...
        if ($this->view->is_cached('news_user_article.htm')) {
            return $this->view->fetch('news_user_article.htm');
        }
    ...
    public function archives($args)
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('news_user_archives.htm');
    }
    ...
    public function preview($args)
    {
        ...
        return $this->view->fetch('news_user_preview.htm');
    }
    ...
    public function categorylist($args)
    {
        ...
        // Return the output that has been generated by this function
        return $this->view->fetch('news_user_categorylist.htm');
    }
    ...
    public function displaypdf($args)
    {
        ...
        $articlehtml = $this->view->fetch('news_user_articlepdf.htm');
