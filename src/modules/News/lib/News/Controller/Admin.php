...
echo "Bindings: <pre>"; print_r(HookUtil::bindingsBetweenProviderAndSubscriber('News', 'MyHookProvider')); echo "</pre>";
echo "Providers: <pre>"; print_r(HookUtil::getProvidersInUseBy('News')); echo "</pre>";
echo "hasProvider(EZC): <pre>"; var_dump(HookUtil::hasProvider('hookhandler.myhookprovider.ui.view')); echo "</pre>";
