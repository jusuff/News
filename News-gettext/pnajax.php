...
function News_ajax_modify()
{
    ...
    if ($item == false) {
        AjaxUtil::error(__('No such news article found.', $dom));
    }
    ...
    switch($story['action']) {
        case 'update':
            ...
            if (pnModAPIFunc('News', 'admin', 'update',
                ...
                if ($item == false) {
                    AjaxUtil::error(__('No such item found.', $dom));
                }
                ...
                $output = __('Error! Update attempt failed.', $dom);
            }
            break;
        ...
        case 'pending':
            ...
            if (DBUtil::updateObject($object, 'news', '', 'sid') == false) {
                ...
                $output = __('Done! News article updated.', $dom);
            }
            break;
        ...
        case 'delete':
            ...
            if (pnModAPIFunc('News', 'admin', 'delete', array('sid' => $story['sid']))) {
                ...
                $reloadurl = pnModURL('News', 'user', 'view', array(), null, null, true);
                $output = __('Done! News article deleted.', $dom);
            } else {
                $output = __('Error! Sorry! Deletion attempt failed.', $dom);
            }
            break;
        default:
    }
